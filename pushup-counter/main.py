                    ...
                    #LOADING IMAGE
                        ...
                        try:
                            ...
                            if round(body_language_prob[np.argmax(body_language_prob)]) < 0.6:
                                cv2.putText(rgb_frame, 'Get into initial position' , (15,12), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (3, 12, 138), 1, cv2.LINE_AA)
                            else :
                                # Display Class
                            ...
                            # Display counter
                            cv2.putText(rgb_frame, 'COUNTER: ' + str(count) , (15,12), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (3, 12, 138), 1, cv2.LINE_AA)
